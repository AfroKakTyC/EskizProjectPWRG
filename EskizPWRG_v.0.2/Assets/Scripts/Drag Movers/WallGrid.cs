...
public class WallGrid : MonoBehaviour
{
	...
	public bool CheckPositionAccesibility(Vector2 coordinates, Vector2Int objectSizeInCells)
	{
		...
		|| centerBoxIndex.y - (objectSizeInCells.y / 2) < 0 || centerBoxIndex.y + (objectSizeInCells.y / 2) >= WallGridArray.GetLength(1))
		{
			return (false);
		}
